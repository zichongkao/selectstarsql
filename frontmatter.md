...
<a name="technicals"></a>
## Technicals
   - <p><strong>Alasql</strong>. One of the challenges to making this site free was to avoid paying for web hosting. But to give users a hands-on experience with a database (see <a href="#pedagogy">Pedagogy</a>), one would have to host and pay for a proper backend somewhere. Thankfully, client-side databases exist. This allows me to serve a static page from <a href="https://pages.github.com">Github Pages</a> for free. The page sets up and runs an <a href="https://github.com/agershun/alasql">Alasql</a> database on your browser. It's not really industrial strength, but does the job!</p>
   ...
   - <p><strong>Jekyll</strong>. I don't know any fancy web technologies, so <a href="https://jekyllrb.com/">Jekyll</a> was the only thing that stopped me from having to write up all the html by hand. Thank goodness for Jekyll.</p>
