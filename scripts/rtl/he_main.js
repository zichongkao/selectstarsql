...
class sqlQuiz extends HTMLElement {
  ...
  connectedCallback() {
    ...
    form['onsubmit'] = (e) => {
      ...
      var res = mistakes >= 2 ? mistakes + " טעויות" :
          mistakes == 1 ? mistakes + " טעויות" : "הכל נכון!"
...
class sqlExercise extends HTMLElement {
  ...
  connectedCallback() {
    ...
    var runButton = `<input class="sql-exercise-submit" type="submit" value="הפעלה &#x21e9;" disabled>`;
    ...
    if (solution) {
      ...
      solutionButton.value = 'הצגת פתרון';
